...
public class RestaurantApprovalEventKafkaPublisher implements RestaurantApprovalResponseMessagePublisher {
    ...
    public RestaurantApprovalEventKafkaPublisher(RestaurantMassagingDataMapper restaurantMassagingDataMapper,
    ...
    public void publish(OrderOutboxMessage orderOutboxMessage,
        ...
        try {
            RestaurantApprovalResponseAvroModel restaurantApprovalResponseAvroModel =
                    restaurantMassagingDataMapper.orderEventPayloadToRestaurantApprovalResponseAvroModel(
