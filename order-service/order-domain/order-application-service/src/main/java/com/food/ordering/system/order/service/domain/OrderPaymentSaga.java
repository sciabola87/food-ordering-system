...
public class OrderPaymentSaga implements SagaStep<PaymentResponse> {
    ...
    public OrderPaymentSaga(OrderDomainService orderDomainService,
                            ...
                            OrderSagaHelper orderSagaHelper, ApprovalOutboxHelper approvalOutboxHelper,
    ...
    public void process(PaymentResponse paymentResponse) {
        ...
        approvalOutboxHelper
                .saveApporvalOutboxMessage(orderDataMapper.orderPaidEventToOrderApprovalEventPayload(domainEvent),
    ...
    public void rollback(PaymentResponse paymentResponse) {
        ...
        if(orderPaymentOutboxMessageResponse.isEmpty()){
            log.info("An outbox message with saga id: {} is already rol backed!",paymentResponse.getSagaId());
            return;
        }
    ...
    private Order rollbackPaymentForOrder(PaymentResponse paymentResponse) {
        ...
        Order order = findOrder(paymentResponse.getOrderId());
        orderDomainService.cancelledOrder(order, paymentResponse.getFailureMessages());
        return order;
    }
    ...
    private OrderApprovalOutboxMessage getUpdatedApprovalOutboxMessage(String sagaId,
        ...
        Optional<OrderApprovalOutboxMessage> orderApprovalOutboxMessageRespose =
