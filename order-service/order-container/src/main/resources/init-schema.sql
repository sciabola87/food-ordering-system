...
CREATE TYPE outbox_status AS ENUM ( 'TARTED', 'COMPLETED', 'FAILED');
...
CREATE INDEX "payments_outbox_saga_status"
ON "order".payments_outbox
    (type, outbox_status, saga_status);

CREATE UNIQUE INDEX "payments_outbox_saga_id"
ON "order".payments_outbox
