...
public class OrderDataMapper {
    ...
    private StreetAddress orderAddressToSteetAddress(OrderAddress orderAddress) {
    ...
    public OrderPaymentEventPayload orderCreatedEventToOrderPaymentEventPayload(OrderCreatedEvent orderCreatedEvent){
        ...
        return OrderPaymentEventPayload.builder()
                ...
                .createAt(orderCreatedEvent.getCreateAt())
    ...
    public OrderApprovalEventPayload orderPaidEventToOrderApprovalEventPayload(OrderPaidEvent orderPaidEvent) {
        ...
        return OrderApprovalEventPayload.builder()
                ...
                .createAt(orderPaidEvent.getCreateAt())
                .build();
    ...
    public OrderPaymentEventPayload orderCancelledEventToOrderPaymentEventPayload(OrderCancelledEvent orderCancelledEvent){
        ...
        return OrderPaymentEventPayload.builder()
                ...
                .createAt(orderCancelledEvent.getCreateAt())
