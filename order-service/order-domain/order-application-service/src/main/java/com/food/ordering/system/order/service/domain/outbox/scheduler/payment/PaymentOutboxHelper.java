...
public class PaymentOutboxHelper {
    ...
    public void deletePaymentOutboxMessageByOutboxStatusAndSagaStatus(OutboxStatus outboxStatus,
                                                                      SagaStatus... sagaStatus){
        paymentOutboxRepository.deleteByTpeAndOutboxStatusAndSagaStatus(ORDER_SAGA_NAME, outboxStatus, sagaStatus);
    }
    ...
    public void savePaymentOutboxMessage(OrderPaymentEventPayload orderPaymentEventPayload,
        ...
        save(OrderPaymentOutboxMessage.builder()
                .id(UUID.randomUUID())
                .sagaId(sagaId)
                .createAt(orderPaymentEventPayload.getCreateAt())
    ...
    private String createPayload(OrderPaymentEventPayload orderPaymentEventPayload) {
        ...
        try {
            ...
            log.error("Could not create OrderPaymentEventPayload object fpr order id: ",
                    orderPaymentEventPayload.getOrderId(),e);
            throw new OrderDomainException("Could not create OrderPaymentEventPayload object fpr order id: " +
