...
public class ApprovalOutboxHelper {
    ...
    public void deleteApprovalOutboxMessageByOutboxStatusAndSagaStatus(OutboxStatus outboxStatus,
                                                                      SagaStatus... sagaStatus){
        approvalOutboxRepository.deleteByTpeAndOutboxStatusAndSagaStatus(ORDER_SAGA_NAME, outboxStatus, sagaStatus);
    }
    @Transactional
    public void saveApporvalOutboxMessage(OrderApprovalEventPayload orderApprovalEventPayload,
        ...
        save(OrderApprovalOutboxMessage.builder()
                .id(UUID.randomUUID())
                .sagaId(sagaId)
                .createAt(orderApprovalEventPayload.getCreateAt())
    ...
    private String createPayload(OrderApprovalEventPayload orderApprovalEventPayload) {
        ...
        try {
            ...
            log.error("Could not create orderApprovalEventPayload object fpr order id: ",
                    orderApprovalEventPayload.getOrderId(),e);
            throw new OrderDomainException("Could not create orderApprovalEventPayload object fpr order id: " +
